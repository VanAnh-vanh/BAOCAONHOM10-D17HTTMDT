...
<body>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="breadcrumb-text">
                        <a href="register.blade.php"><i class="fa fa-home"></i> Home</a>
                        <span>Register</span>
                    </div>
                </div>
            </div>
    ...
    <!-- Register Section Begin -->
<section class="login-register-section spad">
    <div class="container">
        <div class="row">
            <div class="col-lg-6 offset-lg-3">
                <div class="register-form">
                    ...
                    <form action="#" method="POST">
                        ...
                        <button type="submit" class="site-btn login-btn" style="background-color: #d59f2a;">Register</button>
                    </form>
